  ...
  <header class="header_area">
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
        ...
        <nav class="classy-navbar" id="essenceNav">
            ...
            <a class="nav-brand" href="#">ISHOP</a>
                        ...
                        <li><a href="#">Home</a>
                            <div class="megamenu">
                                <ul class="single-mega cn-col-4">
                                    ...
                                    <li><a href="#">Bags & Protector</a></li>
                                </ul>
                                <ul class="single-mega cn-col-4">
                                    <li class="title">Airpods</li>
                                ...
                                <ul class="single-mega cn-col-4">
                                    ...
                                    <li><a href="#">Sries 6</a></li>
                                    <li><a href="#">Serise 7</a></li>
                                    <li><a href="#">eries 8</a></li>
    ...
    <div class="cart-content d-flex">
                ...
                <a href="#" class="product-image">
                    ...
                    <div class="cart-item-desc">
                      <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                        ...
                        <h6>Iphone 13</h6>
                        <p class="size"></p>
                        <p class="color">Color: Startlight</p>
                ...
                <a href="#" class="product-image">
                    ...
                    <div class="cart-item-desc">
                      <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                        ...
                        <h6>Iphone 12</h6>
                        <p class="size"></p>
                        <p class="color">Color: Starlight</p>
        ...
        <div class="cart-amount-summary">
            ...
            <ul class="summary-table">
                <li><span>subtotal:</span> <span>$2297.00</span></li>
                <li><span>delivery:</span> <span>Free</span></li>
                <li><span>discount:</span> <span>-15%</span></li>
                <li><span>total:</span> <span>$1952.00</span></li>
            </ul>
        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="hero-content">
                    ...
                    <a href="#" class="btn essence-btn">Order Now</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="popular-products-slides owl-carousel">
                    ...
                    <div class="single-product-wrapper">
                        ...
                        <div class="product-description">
                            ...
                            <p class="product-price"><span class="old-price">$699.00</span>$599</p>
